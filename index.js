const {
    ...
    proto
} = require('baileys-pro')  // <-- මෙතන '@whiskeysockets/baileys' වෙනුවට 'manul-ofc-baileys' යොදන්න
...
if (!fs.existsSync(__dirname + '/lib/creds.json')) {
    if (config.SESSION_ID) {
      const sessdata = config.SESSION_ID.replace("𝐆𝐎𝐉𝐎-𝐌𝐃=", "")
...
//==================================================================
  ...
  //SORY BRO SETTINGS PLUGINS NOT 💔👨‍🔧💬 IAM GOJO
